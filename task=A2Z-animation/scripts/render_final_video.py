...
def main():
    ...
    result = subprocess.run(
        [str(FFMPEG), "-y", "-v", "error", "-i", str(out_path),
         ...
         "-vf", "scale=1920:960,pad=1920:1080:0:0:color=0x101010,subtitles=narration/subtitles.srt:force_style='FontName=Microsoft JhengHei,FontSize=12,PrimaryColour=&H00FFFFFF,BorderStyle=3,Outline=10,Shadow=0,BackColour=&H88000000,MarginL=30,MarginR=30,MarginV=14'",
         "-c:v", "libx264", "-preset", "veryfast", "-crf", "18",
         "-c:a", "copy", str(subbed)],
